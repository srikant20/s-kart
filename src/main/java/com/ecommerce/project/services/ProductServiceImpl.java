...
public class ProductServiceImpl implements ProductService{
    ...
    public ProductResponse getAllProducts(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        if(products.isEmpty()){
            throw new APIException("Currently, there no any products exists.!!");
        }
        ...
        productResponse.setPageElement(productPage.getTotalElements());
    ...
    public ProductResponse searchByCategory(Long categoryId, Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        if(products.isEmpty()){
            throw new APIException("Currently, products not available!!");
        }
        ProductResponse productResponse = new ProductResponse();
        productResponse.setContent(productDTOS);
        productResponse.setPageNumber(productPage.getNumber());
    ...
    public ProductResponse searchProductByKeyword(String keyword, Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        if(products.isEmpty()){
            throw new APIException("Currently, no product available.!!");
        }
        ProductResponse productResponse = new ProductResponse();
        productResponse.setContent(productDTOS);
        productResponse.setPageNumber(productPage.getNumber());
